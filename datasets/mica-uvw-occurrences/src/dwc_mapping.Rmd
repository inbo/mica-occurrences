...
input_interim <- read_csv2(file = here::here("datasets", "mica-uvw-occurrences", "data", "raw", "Vangstgegevens muskus- en beverratten_NL_2014-2021.csv"))
```
...
```{r}
write_csv(occurrence, here::here("datasets/mica-uvw-occurrences", "data", "processed", "occurrence2.csv"), na = "")
