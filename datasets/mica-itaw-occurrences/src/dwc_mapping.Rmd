...
```{r}
occurrence %<>% rename(individualCountNotSure= Vangë) 
```
...
occurrence %<>% select(-c(UserName, UserEmail, Datum, Uhrzeit, Tier, "Anmerkung (nicht verpflichtend)",year, month, day, verbatimLongitude, verbatimLatitude ))  #remove collection columns
