...
input_file <- read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vTlox8fOH1RL_W9QauvK7Leo50uGNHS0Bzikt6V6xfpOPQ-KRMqXPMCI0SiCPK5YhjBEqVwXoeDbHgn/pub?output=csv")
...
```{r}
occurrence %<>% mutate(habitat = Landschaft)
```
...
occurrence %<>% mutate(samplingProtocol = recode(Material,
                            ...
                            "1" =	 "Metallkastenfalle (Fa. Grimm)/ Metal Box Trap"
                          , "2" =  "Abschuss / shot"
                          , "3" =  "Weka invasiv / funnel trap"
                          , "4" =  "Drahtkastenfalle / wire box trap"
                          , "5" =  "Trapperneozoen /  funnel trap"
                          , "6" =  "Holzkastenfalle / wooden box trap"
                          , "7" =  "Haargreiffalle (Modell Hausmann) / ground trap"
                          , "8" =  "Reusenfalle"
                          , "9" =  "Conibear-Falle / Conibear trap"
                          , "10" = "Leprich-Falle  / Leprich Trap/ bait trap"
                          , "11" = "Runde Uferfalle / bait trap"
                          , "12" = "Kerschl-Falle" ))
...
```{r}
occurrence %<>% mutate(verbatimScientificName = Tier)
```
...
col_order <- c( "type","language","license","rightsHolder","accessRights","datasetID"
               ...
               # removed for this dataset,"occurrenceRemarks","municipality","samplingProtocol","samplingEffort", ,"locationID", ,"verbatimLatitude","verbatimLongitude","verbatimSRS"
