...
```{r}
input_interim <- read_csv("../data/interim/RATO_data_RAW_Refine.csv")                        
```
...
write_csv(x_y, "../data/interim/x_y.csv", na = "")
```
...
```{r}
write_csv(occurrence, "../data/processed/occurrence.csv", na = "")
```
