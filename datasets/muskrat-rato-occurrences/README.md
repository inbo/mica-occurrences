...
This repository contains the functionality to standardize the data of _MICA - Muskrat occurrences collected by RATO in East Flanders, Belgium_ to a [Darwin Core Occurrence](https://www.gbif.org/dataset-classes) that can be harvested by [GBIF](http://www.gbif.org).
...
* [Dataset on GBIF](https://doi.org/10.15468/5fps96)
