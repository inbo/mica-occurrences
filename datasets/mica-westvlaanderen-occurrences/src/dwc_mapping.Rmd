...
```{r}
input_interim %<>% mutate(verbatimLongitud = (x/1000000000000)) %>%
                   mutate(verbatimLatitud = (y/100000000000)) 
                   
```
```{r}
input_interim %<>% mutate(verbatimLongitude = (x/1000000000000)) %>%
                   mutate(verbatimLatitude = (y/100000000000)) 
