...
```{r}
input_data <- read_csv(file = here::here("datasets", "mica-legacy-occurrences", "data", "raw", "AgrDataGBIF.csv"), guess_max = 400000)
```
...
write_csv(occurrence_presence_only, here::here("datasets", "mica-legacy-occurrences", "data", "processed", "occurrence.csv"), na = "")
```
