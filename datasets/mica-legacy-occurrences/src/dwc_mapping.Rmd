...
```{r}
input_data <- read_csv("../data/raw/AgrDataGBIF.csv"), guess_max = 400000)
```
...
```{r}
write_csv(occurrence, "../data/processed/occurrences_with_absence.csv", na = "" )
write_csv(occurrence_presence_only, "../data/processed/occurrence.csv", na = "")
```
