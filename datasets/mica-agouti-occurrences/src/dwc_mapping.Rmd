...
```{r}
agouti_export <- "~/Downloads/mica-management-of-invasive-coypu-and-muskrat-in-europe-20221012105236/datapackage.json"
...
```{r}
package$contributors <- purrr::discard(package$contributors, ~.[["email"]] == "kelly.meijvisch@outlook.be")
```
