...
```{r}
agouti_export <- "~/Downloads/mica-management-of-invasive-coypu-and-muskrat-in-europe-20230601061026/datapackage.json"
...
package$data$deployments <- 
  ...
  mutate(comments = recode(comments, "null" = NA_character_))
```
...
purrr::pluck(
  contributors[
    purrr::map_lgl(package$contributors,
    ~ purrr::pluck(.x, "title") == "saida feresin")
  ], 1, "title"
) <- "Saida Feresin"
```
