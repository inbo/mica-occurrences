...
package$description <- c(
  ...
  "Generalized and/or withheld information: to prevent camera trap theft, coordinates are rounded to 3 decimals (111m).", # TODO
...
TODO: round coordinates to 3 decimals and set coordinate uncertainty to 157m maximum, see <https://github.com/inbo/mica-occurrences/issues/6> and <https://docs.gbif.org/georeferencing-best-practices/1.0/en/#table-uncertainty>
